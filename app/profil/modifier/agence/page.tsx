    ...
    <main className="flex min-h-screen bg-slate-900 flex-col items-center font-sans">
      <div className="h-auto w-3/4 sm:w-3/4 my-10 lg:w-1/2  flex flex-col gap-5">
        ...
        <p className="text-white font-normal">
          ...
          encore. Cet écran est essentiel pour garantir que votre agence soit
          bien représentée auprès des utilisateurs potentiels. Une présentation
          claire et précise de votre agence peut augmenter la confiance des
          utilisateurs et attirer plus de clients. Prenez le temps de mettre à
          jour vos informations pour maximiser votre visibilité et votre
          crédibilité sur notre plateforme.
        </p>
      </div>
